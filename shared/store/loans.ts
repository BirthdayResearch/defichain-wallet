...
export const loanTokensSelector = (state: LoansState): LoanToken[] =>
  state.loanTokens;
...
export const loanPaymentTokenActivePrices = (
  state: LoansState,
): LoanPaymentTokenActivePrices => state.loanPaymentTokenActivePrices;
