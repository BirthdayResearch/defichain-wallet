      ...
      >
              ...
              >
                <ThemedText
                  ...
                  light={tailwind("text-primary-500", {
                    "text-gray-300": pasteButton.isPasteDisabled,
                  })}
                  dark={tailwind("text-darkprimary-500", {
                    "text-gray-700": pasteButton.isPasteDisabled,
                  })}
                >
        ...
        <ThemedView
          ...
          dark={tailwind(
            `bg-gray-800 ${
              !valid
                ? "border-darkerror-500"
                : isFocus
                ? "border-darkprimary-300"
                : editable
                ? "border-gray-600"
                : "border-gray-800"
            }`
        ...
        >
          <ThemedView
            ...
            style={[
              tailwind("flex-row items-center p-2 justify-between"),
  ...
  return (
    ...
    >
      <ThemedView
        ...
        style={tailwind("top-2 left-3 rounded-full absolute w-9/12 h-4 -z-1", {
          "w-5/12": Platform.OS === "web",
        })}
      />
      <ThemedIcon
        iconType="MaterialIcons"
...
const TextInputDefault = forwardRef(
  (props: WalletTextInputProps, ref: React.Ref<any>) => {
    ...
    return (
      <ThemedTextInput keyboardType={inputType} ref={ref} {...otherProps} />
    );
  }
);
