...
export function dDOGE(props: SvgProps): JSX.Element {
  // Current types are not working properly
  const GElement = G as any;
  const MaskElement = Mask as any;
  return (
    <Svg height={32} width={32} viewBox="0 0 32 32" {...props}>
      ...
      <GElement fill="none" fillRule="evenodd">
        <Path
          d="M16 0C7.163 0 0 7.163 0 16s7.163 16 16 16 16-7.163 16-16S24.837 0 16 0z"
          fill="#F3EDD6"
          fillRule="nonzero"
        ...
        <MaskElement fill="#fff" id="dDOGE_svg__b">
          <Use xlinkHref="#dDOGE_svg__a" />
        </MaskElement>

        <GElement mask="url(#dDOGE_svg__b)">
          <Path
          ...
          <GElement transform="translate(16.667 31.218)">
            <MaskElement fill="#fff" id="dDOGE_svg__d">
          ...
          <GElement transform="translate(4.5 19.57)">
            <MaskElement fill="#fff" id="dDOGE_svg__f">
          ...
          <GElement transform="translate(9.87 2)">
            <MaskElement fill="#fff" id="dDOGE_svg__h">
          ...
          <GElement transform="translate(4.487 16.795)">
            <MaskElement fill="#fff" id="dDOGE_svg__j">
          ...
          <GElement transform="translate(4.482 14.881)">
            <MaskElement fill="#fff" id="dDOGE_svg__l">
          ...
          <GElement transform="translate(22.846 22.127)">
            <MaskElement fill="#fff" id="dDOGE_svg__n">
          ...
          <GElement transform="translate(10.679 2)">
            <MaskElement fill="#fff" id="dDOGE_svg__p">
