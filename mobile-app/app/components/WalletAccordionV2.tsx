    ...
    >
      ...
      <Accordion
          ...
          return (
            ...
            >
              <ThemedTextV2
                ...
                light={tailwind(isActive ? 'text-mono-light-v2-900' : 'text-mono-light-v2-700')}
                dark={tailwind(isActive ? 'text-mono-dark-v2-900' : 'text-mono-dark-v2-700')}
              >
                {prop.title}
              </ThemedTextV2>
              <ThemedIcon
        ...
        renderContent={(prop, index, isActive) => {
          return (
            <ThemedViewV2
              style={[tailwind('mx-5 py-4'), isActive && !isLastContent(index) && tailwind('border-b')]}
              light={tailwind('border-mono-light-v2-300')}
              dark={tailwind('border-mono-dark-v2-300')}
            >
