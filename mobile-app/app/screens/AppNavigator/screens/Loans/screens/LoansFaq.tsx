...
export function LoansFaq({ route }: Props): JSX.Element {
  ...
  const faqContent: AccordionContent[] = [
      ...
      content: [
        {
          text: translate(
            "components/LoansFaq",
            "The collateralization ratio determines the state of the vault. A ratio below the minimum collateralization ratio results in liquidation, upon which, a vault's collateral will be sent for auction."
          ),
          type: "paragraph",
        },
        {
    ...
    },
    {
      title: translate(
        "components/LoansFaq",
        "What do the different statuses of a vault mean?"
      ),
      content: [
        {
          text: translate(
