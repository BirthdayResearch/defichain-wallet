...
export function CreateVaultScreen ({
  ...
  const isConversionRequired = new BigNumber(3).gt(DFIUtxo.amount)
  ...
  const onSubmit = async (): Promise<void> => {
    ...
    if (isConversionRequired) {
      queueConvertTransaction({
        mode: 'accountToUtxos',
        amount: new BigNumber(3).minus(DFIUtxo.amount)
      }, dispatch, () => {
        navigation.navigate({
          ...
          params: {
            ...
            conversion: {
              ...
              conversionAmount: new BigNumber(3).minus(DFIUtxo.amount)
            }
          }
        })
      }, logger)
