...
describe("loan cards", () => {
  it("should match snapshot", async () => {
    ...
    const loanCards: LoanToken[] = [
      {
        tokenId:
          "3a7e97db4b913fd249da2a59f2edd84f34e111fe1c775a01addfb3b96c147d40",
        token: TS25,
        interest: "2",
      ...
      {
        tokenId:
          "57135919430b915f6f462142161e94474aae824791fa3644541102d7a7959a63",
        token: TR50,
        interest: "3",
      ...
      {
        tokenId:
          "943c2f38cf418ff116c402f4f6ec400039223e5aa4fb41f2c4a6e69ac53a4c45",
        token: TU10,
        interest: "1",
