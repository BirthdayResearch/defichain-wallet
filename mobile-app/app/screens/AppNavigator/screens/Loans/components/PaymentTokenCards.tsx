...
export function PaymentTokenCards({
  ...
  return (
    <>
      ...
      />
      <View style={tailwind("flex flex-row justify-center mx-2")}>
      ...
      {(selectedPaymentTokenSymbol === "DFI" ||
        (selectedPaymentTokenSymbol === "DUSD" &&
          loanTokenSymbol !== "DUSD")) && (
        <View style={tailwind("flex flex-row mx-3 ml-2 p-1 flex-wrap")}>
          ...
          >
            {translate(
              ...
              "A 5% fee is applied when you pay with {{tokenSymbol}}.",
            ...
            >
              <View
                style={tailwind(
                  "flex flex-row items-center relative -bottom-0.5 ml-1"
                )}
              >
                <ThemedIcon
