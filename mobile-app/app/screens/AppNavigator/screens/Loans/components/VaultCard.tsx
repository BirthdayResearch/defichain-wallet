    ...
    >
      ...
      >
        ...
        <View style={tailwind('flex flex-row flex-wrap -mb-2')}>
          ...
          <VaultInfo
            label='Total loan amount (USD)' value={new BigNumber(vault.loanValue ?? 0)} prefix='$'
            decimalPlace={2} valueType='NUMBER'
          />
          <VaultInfo
            label='Collateral amount (USD)' value={new BigNumber(vault.collateralValue ?? 0)} prefix='$'
            decimalPlace={2}
            valueType='NUMBER'
          />
          <VaultInfo
            ...
            decimalPlace={2}
            valueType='NUMBER'
            valueThemedProps={vault.collateralRatio !== undefined ? getCollateralRatioColor(new BigNumber(vault.collateralRatio)) : undefined}
          />
        </View>
      </ThemedTouchableOpacity>
