...
export const ViewSlippageToleranceInfo = (): React.MemoExoticComponent<
  () => JSX.Element
> =>
  memo(() => {
    const slippageInfo = {
      ...
      content:
        "Slippages are rate charges that occur within an order transaction. Note that the slippage tolerance also includes the DEX stablizaion fees. Choose how much of this slippage you are willing to accept",
    };
    return (
