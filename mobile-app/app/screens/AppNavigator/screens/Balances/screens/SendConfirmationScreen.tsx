...
function LpAcknowledgeSwitch (props: {isAcknowledge: boolean, onSwitch: (val: boolean) => void}): JSX.Element {
  return (
    <View style={tailwind('mx-4 mt-8 flex flex-row items-center')}>
      ...
      >
        {translate('components/SendConfirmationScreen', 'I acknowledge that sending LP tokens to addresses that are not DeFiChain compatible wallets may result in irreversible loss of funds.')}
      </ThemedText>
    </View>
  )
}
