...
//           title={translate('screens/SellConfirmationScreen', 'You are sending')}
//         />
...
//         text={translate('screens/SellConfirmationScreen', 'TRANSACTION DETAILS')}
//       />

//       <TextRow
//         lhs={translate('screens/SellConfirmationScreen', 'Transaction type')}
//         rhs={{
//           value: conversion?.isConversionRequired === true ? translate('screens/SellConfirmationScreen', 'Convert & send') : translate('screens/SellConfirmationScreen', 'Send'),
...
//       <WalletAddressRow />
//       <TextRow
//         lhs={translate('screens/SellConfirmationScreen', 'Recipient address')}
//         rhs={{
//           value: destination,
...
//       <NumberRow
//         lhs={translate('screens/SellConfirmationScreen', 'Amount to send')}
//         rhs={{
...
//         label={translate('screens/SellConfirmationScreen', 'CONFIRM SEND')}
//         isProcessing={isSubmitting || hasPendingJob || hasPendingBroadcastJob}
//         processingLabel={translate('screens/SellConfirmationScreen', getSubmitLabel())}
//         onCancel={onCancel}
//         onSubmit={onSubmit}
//         displayCancelBtn
//         title='send'
...
//       >
//         {translate('screens/SellConfirmationScreen', 'Send Liquidity Pool tokens only to DeFiChain Wallet addresses. Sending to an exchange (except DFX) or a central entity will result in irreversible loss of funds.')}
//       </ThemedText>
//     </View>
//   )
// }
...
//       sign: signer,
//       title: translate('screens/SellConfirmationScreen', 'Sending', { symbol: token.displaySymbol }),
//       description: translate('screens/SellConfirmationScreen', 'Sending {{amount}} {{symbol}}', {
