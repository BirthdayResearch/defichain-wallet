...
export function EmptyBidsScreen(): JSX.Element {
  return (
    ...
    >
      ...
      <ThemedText
        testID="empty_bid_title"
        style={tailwind("text-2xl pb-1 font-semibold text-center")}
      >
        {translate("components/EmptyBidsScreen", "No active bids")}
      </ThemedText>

      <ThemedText
        testID="empty_bid_subtitle"
        style={tailwind("text-sm px-8 pb-4 text-center opacity-60")}
      >
        {translate(
          "components/EmptyBidsScreen",
          "To get started, browse on auctions and place a bid"
        )}
      </ThemedText>
