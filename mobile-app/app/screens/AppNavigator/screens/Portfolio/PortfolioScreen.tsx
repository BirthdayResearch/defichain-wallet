...
import { DfxButtons } from '@screens/AppNavigator/screens/Portfolio/components/DfxButtons'
...
function BalanceActionSection ({
  ...
  return (
    <View style={tailwind('flex flex-row mx-4')}>
      ...
      <BalanceActionButton type='RECEIVE' onPress={() => navigation.navigate('ReceiveDTokenScreen')} />
    </View>
  )
}
