...
export function AddressSelectionButton(
  ...
  return (
    <ThemedTouchableOpacity
      ...
      style={tailwind(
        "rounded-2xl p-1 pr-2 flex flex-row items-center overflow-hidden"
      )}
      ...
      {props.addressLength > 0 && props.hasCount && (
        ...
        >
          <ThemedText
            ...
            style={tailwind("text-2xs h-4 font-medium text-center leading-4", {
              "relative top-0.5 leading-3": Platform.OS === "android",
            })}
