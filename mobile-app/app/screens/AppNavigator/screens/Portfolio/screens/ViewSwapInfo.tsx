...
export const ViewSwapInfo = ({
  ...
  executionBlock,
  transactionDate
}: ViewSwapInfoProps): React.MemoExoticComponent<() => JSX.Element> => memo(() => {
  ...
  return (
    <ThemedViewV2
      style={tailwind('flex-col px-5 h-full flex flex-grow', { '-mt-0.5': Platform.OS === 'ios' }, { '-mt-1': Platform.OS === 'android' })}
    >
      <View
        style={tailwind('pb-9 flex-row items-center', { 'mt-1': Platform.OS === 'ios' }, { 'mt-2': Platform.OS === 'android' })}
      >
        <View>
          <PoolPairIconV2
      ...
      <NumberRowV2
        lhs={{
          value: translate('screens/WithdrawFutureSwapScreen', 'Amount to swap'),
        ...
        rhs={{
          ...
          usdAmount: getTokenPrice(source.symbol, new BigNumber(source.amount)),
      ...
      <NumberRowV2
        lhs={{
          value: translate('screens/WithdrawFutureSwapScreen', 'Settlement block'),
          themedProps: themedProps,
      ...
      />
      <ThemedTextV2
        style={tailwind('text-sm font-normal-v2 pb-4 pt-1 text-right justify-end')}
        light={tailwind('text-mono-light-v2-700')}
        dark={tailwind('text-mono-dark-v2-700')}
      >
        {transactionDate}
      ...
      <TextRowV2
        lhs={{
          value: translate('screens/WithdrawFutureSwapScreen', 'To receive (est.)'),
          themedProps: themedProps,
