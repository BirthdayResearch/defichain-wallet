...
export function ConfirmWithdrawFutureSwapScreenV2 ({
  route,
  navigation
}: Props): JSX.Element {
  const {
    ...
    >
      <View>
        ...
        >
          <NumberRowV2
            lhs={{
              value: translate('screens/ConfirmWithdrawFutureSwapScreen', 'Transaction fee'),
          ...
          <NumberRowV2
            containerStyle={{ style: tailwind('flex-row items-start w-full bg-transparent pt-5') }}
            lhs={{
              value: translate('screens/ConfirmWithdrawFutureSwapScreen', 'To receive (est.)'),
              themedProps: themedProps,
      ...
      <View style={tailwind('pt-12 mx-3')}>
        <SubmitButtonGroupV2
          ...
          label={translate('screens/ConfirmWithdrawFutureSwapScreen', 'Withdraw')}
          displayCancelBtn
          onSubmit={onSubmit}
          onCancel={onCancel}
        />
...
async function withdrawFutureSwap ({
  ...
  try {
    ...
    dispatch(transactionQueue.actions.push({
      sign: signer,
      title: translate('screens/ConfirmWithdrawFutureSwapScreen', 'Withdrawing {{amountToWithdraw}} {{sourceSymbol}} from {{sourceSymbol}}-{{destinationSymbol}} swap', {
      ...
      drawerMessages: {
        ...
        waiting: translate('screens/OceanInterface', 'Withdrawing {{amountToWithdraw}} {{sourceSymbol}} from future swap…', {
          amountToWithdraw: amountToWithdraw,
          sourceSymbol: sourceSymbol
        }),
