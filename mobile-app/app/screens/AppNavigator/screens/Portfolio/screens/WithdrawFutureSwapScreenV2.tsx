...
export function WithdrawFutureSwapScreenV2 (props: Props): JSX.Element {
  const {
    futureSwap: {
      source,
      destination
  ...
  function showToast (type: AmountButtonTypes): void {
    ...
    toast.show(translate('screens/WithdrawFutureSwapScreen', toastMessage, toastOption), {
      type: 'wallet_toast',
      placement: 'top',
  ...
  return (
    <ThemedScrollViewV2 ref={containerRef} contentContainerStyle={tailwind('flex-grow justify-between pb-12 pt-8')}>
      <View>
        <ViewPoolHeader
          tokenASymbol={source.displaySymbol}
          tokenBSymbol={destination.displaySymbol}
          headerLabel={translate('screens/WithdrawFutureSwapScreen', 'View swap info')}
          onPress={expandModal}
        ...
        <View style={tailwind('flex-col mt-2 px-5')}>
          <ThemedSectionTitleV2
            ...
            text={translate('screens/WithdrawFutureSwapScreen', 'I WANT TO WITHDRAW')}
          />
          <TransactionCard
    ...
    />
        ...
        {amountToWithdraw.length > 0 && (
          <View style={tailwind('flex-col')}>
            ...
            >
              {translate('screens/WithdrawFutureSwapScreen', 'Review full details in the next screen')}
            </ThemedTextV2>
          </View>
        )}
      </View>
      ...
      <View style={tailwind('w-full px-12')}>
        <ButtonV2
          ...
          disabled={hasPendingJob || hasPendingBroadcastJob || new BigNumber(amountToWithdraw).isNaN() || new BigNumber(amountToWithdraw).isZero() || isEnded}
          styleProps='w-full'
          onPress={onSubmit}
