...
export function WithdrawFutureSwapScreenV2 (props: Props): JSX.Element {
  ...
  return (
    <View ref={containerRef} style={tailwind('flex-col flex-1')}>
      <ThemedScrollViewV2 contentContainerStyle={tailwind('flex-grow justify-between pb-12 pt-8')}>
        <View>
          <ViewPoolHeader
        ...
        <View style={tailwind('w-full px-12')}>
          <ButtonV2
            ...
            disabled={hasPendingJob || hasPendingBroadcastJob || new BigNumber(amountToWithdraw).isNaN() || new BigNumber(amountToWithdraw).isZero() || isEnded || hasError}
            styleProps='w-full'
            onPress={onSubmit}
