    ...
    >
      <View style={tailwind("px-5 mb-12")}>
        ...
        >
          {translate(
            "screens/VerifyMnemonicWallet",
            "Verify the written recovery words."
          )}
        </ThemedTextV2>
      </View>
    ...
    <View style={tailwind("mb-5")}>
      <View style={tailwind("flex-row")}>
        ...
        >
          {translate(
            "screens/VerifyMnemonicWallet",
            `{{number}}${getOrdinalSuffix(index + 1)}`,
            { number: index + 1 }
          )}
        </ThemedTextV2>
        <ThemedTextV2
      ...
      <ThemedViewV2
        ...
        style={tailwind(
          "flex flex-row mt-2 justify-between items-center w-full rounded-3xl"
        )}
