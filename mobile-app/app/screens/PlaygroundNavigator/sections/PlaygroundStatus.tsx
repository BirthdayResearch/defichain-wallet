  ...
  const dataLists = [
    {
      ...
      rhsChildren: (): JSX.Element => {
        return (
          <PlaygroundStatus {...{ online: wallets.length > 0, offline: wallets.length === 0 }} />
        )
      }
    },
    {
...
interface RowDataItemsProps {
    title: string
    rhsChildren?: FunctionComponent
}

export function RowDataItems ({ data, isLast }: {isLast: boolean, data: RowDataItemsProps}): JSX.Element {
  return (
    <ThemedTouchableListItem isLast={isLast}>
