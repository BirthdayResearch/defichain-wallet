context("Wallet - Portfolio - Announcements", () => {
  ...
  it("should display announcement message", () => {
    cy.intercept("**/announcements", {
      statusCode: 200,
  ...
  it("should display announcement message - translated", () => {
    cy.intercept("**/announcements", {
      statusCode: 200,
      body: sampleAnnouncements,
    });
  ...
  it("should be able to close announcement for newer app version", () => {
    cy.intercept("**/announcements", {
      statusCode: 200,
      body: sampleAnnouncementsWithID,
    });
    cy.wait(3000);
    cy.getByTestID("close_announcement")
      .click()
      .then(() => {
        cy.wait(3000);
...
context(
  ...
  () => {
    ...
    it("should be able to display announcement with ID not within hidden list", () => {
      cy.intercept("**/announcements", {
        statusCode: 200,
        body: sampleAnnouncementsWithID,
      });
...
context(
  ...
  () => {
    ...
    it("should handle failed blockchain API status calls", () => {
      cy.intercept("**/blockchain", {
        statusCode: 404,
        body: "404 Not Found!",
        headers: {
    ...
    it("should handle failed overall (ocean) API status calls", () => {
    ...
    it("should not display banner if no outage", () => {
      cy.intercept("**/blockchain", {
        statusCode: 200,
        body: operational,
      });
    ...
    it("should be able to display announcement if no blockchain outage", () => {
      cy.intercept("**/blockchain", {
        statusCode: 200,
        body: operational,
      });
    ...
    it("should be able to display announcement if no (overall) ocean outage", () => {
      cy.intercept("**/overall", {
        statusCode: 200,
        body: operational,
      });
    ...
    it("should be able to display blockchain status down", () => {
      cy.intercept("**/blockchain", {
        statusCode: 200,
        body: outage,
      });
    ...
    it("should be able to display overall (ocean) status down", () => {
      cy.intercept("GET", "**/overall", {
        statusCode: 200,
        body: outage,
      });
    ...
    it("should replace existing announcement with overall (ocean) is down warning message", () => {
      cy.intercept("**/overall", {
        statusCode: 200,
        body: outage,
      });
    ...
    it("should display blockchain is down announcement when both blockchain and overall (ocean) apis are down", () => {
      cy.intercept("**/overall", {
        statusCode: 200,
        body: outage,
      });
    ...
    it("should replace existing announcement with blockchain is down announcement when both blockchain and overall (ocean) apis are down", () => {
      cy.intercept("**/overall", {
        statusCode: 200,
        body: outage,
      });
    ...
    it("should display blockchain is down announcement when stats, blockchain and overall (ocean) apis are down", () => {
      cy.intercept("**/overall", {
        statusCode: 404,
        body: "404 Not Found!",
        headers: {
