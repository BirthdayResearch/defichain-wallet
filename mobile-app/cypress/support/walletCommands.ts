...
Cypress.Commands.add(
  "verifyWalletAddress",
  (network: string, addressObject?: { address: string }) => {
...
Cypress.Commands.add("isNetworkConnected", (network: string) => {
  ...
  cy.getByTestID("header_network_icon")
    .find("path")
    .should("have.css", "fill", "rgb(0, 173, 29)");
});

Cypress.Commands.add(
  "checkBalanceRow",
  (id: string, details: BalanceTokenDetail, dynamicAmount?: boolean) => {
