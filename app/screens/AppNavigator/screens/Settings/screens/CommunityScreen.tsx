...
const Communities: CommunityItem[] = [
  { id: 'gh', title: 'Report an issue on Github', url: 'https://github.com/DeFiChange/wallet/issues', icon: 'github' },
  ...
  { id: 'website', title: 'Official Website', url: 'https://dfx.swiss/', icon: 'web' }
